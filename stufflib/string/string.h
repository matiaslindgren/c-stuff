...
struct sl_string sl_string_concat(struct sl_string str1[const static 1], struct sl_string str2[const static 1]);
void sl_string_extend(struct sl_string str1[const static 1], struct sl_string str2[const static 1]);
