...
char** sl_sort_quicksort_str(struct sl_context ctx[static 1], const size_t count, char* src[count]);
char** sl_sort_mergesort_str(struct sl_context ctx[static 1], const size_t count, char* src[count]);
