...
double*
sl_math_linalg_scalar_vmul(const double a, const size_t n, double dst[n], const double src[n]);
double*
sl_math_linalg_vadd(const size_t n, double dst[n], const double lhs[n], const double rhs[n]);
double*
sl_math_linalg_vsub(const size_t n, double dst[n], const double lhs[n], const double rhs[n]);
