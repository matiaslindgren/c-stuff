...
unsigned char* sl_misc_encode_lil_endian(const size_t size, unsigned char dst[size], const size_t value);
unsigned char* sl_misc_encode_big_endian(const size_t size, unsigned char dst[size], const size_t value);
size_t sl_misc_midpoint(const size_t lo, const size_t hi);
size_t sl_misc_vmax_size_t(const size_t n, const size_t v[n]);
void sl_misc_swap(unsigned char a[const static 1], unsigned char b[const static 1], const size_t count);
