...
char* sl_args_find_optional(const struct sl_args args[const static 1], const char arg[const static 1]);
bool sl_args_parse_flag(const struct sl_args args[const static 1], const char arg[const static 1]);
unsigned long long sl_args_parse_ull(const struct sl_args args[const static 1], const char arg[const static 1], const int base);
