...
bool sl_record_reader_read_sparse_data(struct sl_record_reader reader[const static 1], struct sl_span buffer[const static 1]);
bool sl_record_reader_read_dense_data(struct sl_record_reader reader[const static 1], struct sl_span buffer[const static 1]);
bool sl_record_reader_read(struct sl_record_reader reader[const static 1], struct sl_span buffer[const static 1]);
bool sl_record_read_all(struct sl_record record[const static 1], const size_t bufsize, void* buffer);
