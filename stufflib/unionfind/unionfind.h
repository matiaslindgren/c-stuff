...
void sl_unionfind_set_root(const struct sl_unionfind uf[const static 1], const size_t begin, const size_t root);
void sl_unionfind_union(const struct sl_unionfind uf[const static 1], const size_t lhs, const size_t rhs);
