...
int stufflib_math_double_almost(const double lhs, const double rhs, const double eps) {
...
double stufflib_math_linalg_dot(const size_t n, const double v1[n], const double v2[n]) {
  double dot = 0;
...
void stufflib_math_linalg_matmul(const size_t nrows, const size_t ncols,
                                 const double m[nrows][ncols], const double v[ncols],
                                 double out[nrows]) {
