...
struct sl_span sl_string_view_utf8_data(
...
struct sl_string sl_string_concat(const struct sl_string str1[const static 1],
  ...
  const struct sl_span str1_data = sl_string_view_utf8_data(str1);
  const struct sl_span str2_data = sl_string_view_utf8_data(str2);
